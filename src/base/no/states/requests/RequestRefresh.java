...
/**
 * This class represents a request to refresh the state of all doors.
 * It is used to paint the simulator when the page is loaded, and to display
...
public class RequestRefresh implements Request {
  ...
  // pressing the Refresh Request button
  // of the simulator.
  // Also, to quickly test if the partition
  // requests sent by the client app in Flutter
  // works or not, retrieves the state of
  // all the doors so that the simulator can
  // repaint the readers
  public void process() {
